...
[0] = LAYOUT_ansi_84(
	...
	KC_LCTL,	KC_LALT,	KC_LGUI,										KC_SPC, 							KC_MAC_HAEN,	MO(1),   	KC_RCTL,				KC_LEFT,	KC_DOWN,    KC_RGHT),
// layer Mac Fn
[1] = LAYOUT_ansi_84(
...
[2] = LAYOUT_ansi_84(
	...
	KC_LSFT,				KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,				KC_RSFT,	KC_UP,		KC_END,
	KC_LCTL,	KC_LGUI,	KC_LALT,										KC_SPC, 							KC_HAEN,	MO(3),   	KC_RCTL,				KC_LEFT,	KC_DOWN,    KC_RGHT),
// layer win Fn
[3] = LAYOUT_ansi_84(
